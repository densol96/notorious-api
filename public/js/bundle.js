...
exports.logUserOut = exports.logUserIn = void 0;
...
var logUserIn = exports.logUserIn = /*#__PURE__*/function () {
  ...
  return function logUserIn(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var logUserOut = exports.logUserOut = /*#__PURE__*/function () {
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var _startLocation$coordi = _slicedToArray(startLocation.coordinates, 2),
    y = _startLocation$coordi[0],
    x = _startLocation$coordi[1];
  var map = L.map('map').setView([x, y], 8);
  ...
  locations.forEach(function (loc) {
    var _loc$coordinates = _slicedToArray(loc.coordinates, 2),
      y = _loc$coordinates[0],
      x = _loc$coordinates[1];
    points.push([x, y]);
    L.marker([x, y]).addTo(map).bindPopup("Day ".concat(loc.day, ": ").concat(loc.description), {
      autoClose: false
    }).openPopup();
  });
...
var updateAccount = exports.updateAccount = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, data) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/change-my-password' : 'http://127.0.0.1:3000/api/v1/users/update-me';
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
        ...
        case 4:
          result = _context.sent;
          (0, _alerts.showAlert)('success', "Your ".concat(type, " has successfully been updated!"));
          setTimeout(function () {
            location.reload();
          }, 1500);
          _context.next = 12;
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.logUserIn)(email, password);
  });
}

// RENDER THE MAP
var locationString = document.querySelector("#map");
if (locationString) {
  var locations = JSON.parse(locationString.dataset.locations);
...
if (logOutBtn) {
  logOutBtn.addEventListener('click', _login.logUserOut);
}
...
if (changePasswordForm) {
  var button = changePasswordForm.querySelector('button.btn');
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            oldPassword = changePasswordForm.querySelector('#password-current');
            password = changePasswordForm.querySelector('#password');
            passwordConfirm = changePasswordForm.querySelector('#password-confirm');
            _context.next = 7;
            return (0, _updateSettings.updateAccount)('password', {
